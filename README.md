...
🚀 Features
Zero Dependencies: Pure JavaScript/TypeScript scripts for maximum performance.

Event Normalization: Send one event format to multiple platforms simultaneously.

Privacy-First: Built-in hooks for GDPR/CCPA consent management.

Auto-Detection: Automatically detects user environment (browser, OS, device).
